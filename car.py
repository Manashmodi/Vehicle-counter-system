...
cap=cv2.VideoCapture(r"C:\Users\HP\Desktop\v _code\clone\phython\Video.mp4")
...
while True:
    ...
    cv2.line(frame1,(65,count_line_position),(1280,count_line_position),(355,127,0),3)
    ...
    for(i,c) in enumerate(counterSahpe):
        ...
        for(x,y) in detect:
            if y<(count_line_position+offset) and y>(count_line_position-offset):
                counter+=1
            cv2.line(frame1,(65,count_line_position),(1280,count_line_position),(0,127,255),3)
            detect.remove((x,y))
            print("vacile counter:"+str(counter))
